...
// Agentic
// Agentic campaign orchestrator generating content + subject + segments + schedule from a brief
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic campaign orchestrator generating content + subject + segments + schedule from a brief</p>
