...
// Dynamic
// Dynamic content blocks (per-subscriber personalization)

export default function GapDynamic() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-dynamic', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Dynamic</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Dynamic content blocks (per-subscriber personalization)</p>
