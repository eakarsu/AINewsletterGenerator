...
export default function GapChurnDetection() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-churn-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Churn Detection</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>(at-risk subscriber detection)</p>
