...
// Native
// Native CRM/ecommerce integration (Shopify, HubSpot) webhooks

export default function GapNative() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-native', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Native</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Native CRM/ecommerce integration (Shopify, HubSpot) webhooks</p>
