...
// Public
// Public API for embedded signup

export default function GapPublic() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-public', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Public</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Public API for embedded signup</p>
