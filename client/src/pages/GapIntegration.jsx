...
// Integration
// Integration ecosystem syncing CRM + ecommerce for conversion tracking

export default function GapIntegration() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Integration</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Integration ecosystem syncing CRM + ecommerce for conversion tracking</p>
