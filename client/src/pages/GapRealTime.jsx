...
// Real Time
// Real-time subscriber intelligence with churn prediction and auto-segmentation

export default function GapRealTime() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-real-time', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Real Time</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Real-time subscriber intelligence with churn prediction and auto-segmentation</p>
