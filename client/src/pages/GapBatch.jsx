...
// Batch
// Batch content generation per segment with auto-test and winner rollout

export default function GapBatch() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-batch', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Batch</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Batch content generation per segment with auto-test and winner rollout</p>
