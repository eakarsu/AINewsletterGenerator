...
// Feature: Compliance
// Description: Compliance tools (GDPR, CAN-SPAM consent ledger)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Compliance. Compliance tools (GDPR, CAN-SPAM consent ledger)' },
